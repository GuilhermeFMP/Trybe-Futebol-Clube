...
Nono projeto de Back-End fornecido pela instituição Trybe , onde criamos uma api para a aplicação com tudo o que aprendemos anteriormente.


## Aprendizados

Aprendi e apliquei na prática sobre a programação orientada a objetos e os princípios SOLID em uma API RestFul.

## Stack utilizada

**Back-End:** Typescript, Express.js, js, Sequelize, JWT, Mocha, Chai e Node.js.
...
```bash
  git clone git@github.com:GuilhermeFMP/Trybe-Futebol-Clube.git
